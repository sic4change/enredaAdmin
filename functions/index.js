...
exports.deleteResource = functions.firestore
        ...
        return adminFirebase.firestore().doc(`resourcesInvitations/${resourceInvitationId}`).set({resourceInvitationId}, {
            ...
            .then(() => {
                return adminFirebase.firestore().collection('mail').add({
                    to: unemployedEmail,
                    message: {
                        subject: `Invitación: ${resourceName}.`,
                        html:
                            createResourceInvitationTemplate(unemployedName, resourceName, resourceId, resourceDates, resourceDuration, resourceDescription ),
                    }
                }).then(() => console.log('Queued email!'));
                });
            });
    ...
    function createResourceInvitationTemplate(unemployedName, resourceName, resourceId, resourceDates, resourceDuration, resourceDescription ) {
        const resourceInvitationTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-top:1px solid #efefef" width="100%" cellspacing="0" cellpadding="0" role="presentation">
            <tr style="border-collapse:collapse">
            <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:25px"><h2 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:18px;font-style:normal;font-weight:normal;color:#333333">Aquí aprenderás:</h2></td>
            </tr>
            </table></td>
            </tr>
            </table></td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
            <tr style="border-collapse:collapse">
            <td align="center" style="padding:0;Margin:0;padding-top:15px"><!--[if mso]><a href="https://enredawebapp.web.app/${resourceId}" target="_blank" hidden>
            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://enredawebapp.web.app/${resourceId}"
            ...
            <![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-style:solid;border-color:#FFFFFF;background:#00D0CE;border-width:0px;display:inline-block;border-radius:5px;width:auto;mso-hide:all"><a href="https://enredawebapp.web.app/${resourceId}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;display:inline-block;background:#00D0CE;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;padding:10px 20px 10px 20px;mso-padding-alt:0;mso-border-alt:10px solid #00D0CE">Quiero participar</a></span><!--<![endif]--></td>
            </tr>
            </table></td>
            </tr>
            </table></td>
